/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a2d151c2ba86b481547b4b5cff47173d)
...
declare global {
	...
	const PORT: string;
	const RDB_HOST: string;
	const RDB_USER: string;
	const RDB_PASSWORD: string;
	const RDB_NAME: string;
	const POSTS_TABLE_NAME: string;
	const MIYABI_TABLE_NAME: string;
	const USERS_TABLE_NAME: string;
	const DEVELOPERS_TABLE_NAME: string;
	const FOLLOWS_TABLE_NAME: string;
	const DEFAULT_ICON_PATH: string;
	const S3_ACCESS_KEY_ID: string;
	const S3_SECRET_ACCESS_KEY: string;
	const S3_BUCKET_NAME: string;
	const GEMINI_API_KEY: string;
	const CURRENTS_API_KEY: string;
	const NEWS_POST_API_KEY: string;
	const OUR_ID: string;
	const NEWS_USER_ID: string;
